...
pipeConfigure2(
    ...
    outdir="/disk1/wzhang/pipeline_test/hg19_pe",
    data="WGS",
    type="paired",
    JavaMem="8G",
    case="cancer",
...
Configure.virusGenomeCheck(folder="/disk1/wzhang/pipeline_test/virus_genome", build=True)

virusdetect(upstream=fi_caseOut.bowtie2)
