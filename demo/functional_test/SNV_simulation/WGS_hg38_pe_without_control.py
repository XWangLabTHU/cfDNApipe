...
pipeConfigure(
    ...
    outdir="/opt/tsinghua/zhangwei/Pipeline_SNV/WGS_hg38_pe_without_control",
    data="WGS",
    type="paired",
    JavaMem="8G",
    build=True,
...
res = cfDNAWGS(
    inputFolder=r"/opt/tsinghua/zhangwei/Pipeline_SNV/WGS_pe/case",
    idAdapter=True,
    rmAdapter=True,
    dudup=True,
    CNV=False,
...
Configure.snvRefCheck(folder="/home/zhangwei/Genome/SNV_hg38", build=True)
