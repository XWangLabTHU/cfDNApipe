...
pipeConfigure2(
    ...
    outdir="/opt/tsinghua/zhangwei/Pipeline_SNV/WGS_hg38_se_with_control",
    data="WGS",
    type="single",
    JavaMem="8G",
    case="cancer",
...
fi_caseOut, fi_ctrlOut = cfDNAWGS2(
    caseFolder="/opt/tsinghua/zhangwei/Pipeline_SNV/WGS_se/case",
    ctrlFolder="/opt/tsinghua/zhangwei/Pipeline_SNV/WGS_se/ctrl",
    caseName="cancer",
    ctrlName="normal",
    idAdapter=True,
    rmAdapter=True,
...
Configure2.snvRefCheck(folder="/home/zhangwei/Genome/SNV_hg38", build=True)
